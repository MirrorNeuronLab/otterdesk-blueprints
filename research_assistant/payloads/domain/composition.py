...
def run_blueprint(
    blueprint_id: str = "research_assistant",
    *,
    ...
    **_options: Any,
    ...
    if blueprint_id != "research_assistant":
        raise ValueError(f"this runner handles 'research_assistant', got {blueprint_id!r}")
    ...
    return {
        ...
        "blueprint_id": "research_assistant",
        "status": "completed",
        **result,
    }
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run the Research Assistant sample workflow.")
