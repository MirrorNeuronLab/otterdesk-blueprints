...
BLUEPRINT_ID = 'tax_form_ocr_capture_assistant'
BLUEPRINT_NAME = 'Tax Form OCR Capture Assistant'
OUTPUT_TYPE = 'tax_form_ocr_capture_packet'
RECOMMENDED_ACTION = 'review_captured_fields_against_source_forms_before_tax_use'
FIELD_PROFILE = ['form_type', 'taxpayer_name', 'taxpayer_id', 'wages', 'deductions', 'credits', 'line_items', 'computed_totals', 'field_locations']
DATASET_INPUT = {'name': 'NIST Special Database 2 and NIST Special Database 6', 'provider': 'National Institute of Standards and Technology', 'url': 'https://www.nist.gov/srd/nist-special-database-2', 'alternate_url': 'https://www.nist.gov/srd/nist-special-database-6', 'license': 'NIST free reference data; review source terms before production use.', 'availability_note': 'Public NIST structured-form reference sets with simulated tax submissions, form images, and answer files.', 'expected_files': ['*.png', '*.fmt', 'field context tables'], 'download_hint': 'Download the Special Database 2 or 6 ZIP from NIST, then point document_sources.folder_path at an extracted submission folder.'}
