# Bibblio GTM Co-worker v1 Specification

## Purpose

Own GTM discovery, seed-contact qualification, partnerships, and draft outreach in service of the shared goal: Turn Bibblio into a profitable business.

## Independence contract

The blueprint declares exactly one domain specialist and two sequential steps: qualify_seed_contacts followed by publish_gtm_outreach_queue. It produces its own final artifact and does not depend on any other Bibblio blueprint to complete.
