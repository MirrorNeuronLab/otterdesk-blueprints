...
export const useGame = create(
  subscribeWithSelector(() => ({
    ...
    touchMode: false,
    ballActive: false,
    // Only enabled by ?control=1. A connected browser tab is the sole
    // simulator authority for the bounded MCP service.
    remoteControl: { enabled: false, status: "offline", lease: "none" },
