...
import RemoteStatus from "./ui/RemoteStatus.jsx";
import { useGame } from "./store.js";
import { isMcpControlMode } from "./bridge/controlMode.js";
import { signed } from "./game/signed.js";

export default function App() {
  useEffect(() => {
    const params = new URLSearchParams(location.search);
    const controlMode = isMcpControlMode(location.search);
    window.__microduckControlMode = controlMode;
    ...
    if (params.get("boot") === "1" || controlMode) {
