...
| [`vc_assistant`](vc_assistant/README.md) | Finance | Monitors startup document folders, runs specialist web-research and deterministic numerical scoring agents, audits seven VC heuristics, and writes score-only report batches. |
