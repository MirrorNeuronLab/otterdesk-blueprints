...
| [`multi_agent_research_coscientist`](multi_agent_research_coscientist/README.md) | Science | A multi-agent research co-scientist for finding, evaluating, and drafting research directions. Give it a research goal, domain, constraints, seed ideas, and an input folder; it retrieves local evidence, performs bounded public research, generates and critiques hypotheses, and writes a review-ready research packet to the output folder. |
