...
| [`vc_assistant`](vc_assistant/README.md) | Finance | Monitors startup document folders, researches public context, applies seven early VC heuristic scoring methods, and writes score-only reports. |
