...
| [`customer_lifecycle_coworker`](customer_lifecycle_coworker/README.md) | Business | Turns de-identified customer feedback into activation, retention, product, and lifecycle decisions. |
