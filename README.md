...
| [`software_architecture_advisor`](software_architecture_advisor/README.md) | Engineering | An air-gapped, read-only software architecture advisor. Give it a local source folder or a GitHub URL pre-staged by OtterDesk; it produces evidence-backed architecture analysis and copy-ready improvement prompts without changing code. |
