...
WORKER_ID = "bibblio_finance_controller"
WORKER_ROLE = "AI Chief Financial Officer and Unit Economics Controller"
ASPECT_ARTIFACT_ID = "bibblio_finance_packet"
ASPECT_PACKET_PATH = "bibblio_finance_packet.json"
