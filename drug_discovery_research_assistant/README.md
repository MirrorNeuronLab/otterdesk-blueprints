...
3. Let the `Drug Discovery Research Assistant` observe intermediate state, produce decisions or artifacts, and emit typed messages.
...
```bash
mn blueprint run drug_discovery_research_assistant
```
