# Property Deal Research Assistant SPEC

## What We Want To Achieve

Build a reviewable property research workflow that helps real-estate investors, acquisition analysts, property-tech teams, and diligence operators move from noisy deal flow to plain-language opportunity rankings. Rank property acquisition opportunities using ZIP-code history, broker notes, financing constraints, and deal memory. The target customer should understand what changed, why the system drafted an option, and what evidence a human should review before acting.
...
The blueprint is organized as a MirrorNeuron workflow with stable identity, configurable inputs, structured events, and a final artifact. The main agent role is Property Deal Research Assistant. The workflow uses zip-code property market simulation with large historical memory and demonstrates large synthetic finance context, working memory retrieval, source refs, decision quality benchmark, with/without memory comparison, and LLM investment reasoning.
