...
All actor-style LLM analysis is configured to use the local OtterDesk system model `gemma4:e2b` through Docker Model Runner. Numerical formulas and missing-evidence gates remain deterministic.
