...
def run_claim_normalizer(ctx: dict[str, Any], *, llm_client: Any | None = None) -> dict[str, Any]:
    ...
    return {"processed_company_count": len(processed), "skipped_company_count": len(skipped)}
