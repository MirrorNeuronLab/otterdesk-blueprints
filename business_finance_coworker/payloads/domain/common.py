...
WORKER_ID = "business_finance_controller"
WORKER_ROLE = "Business Finance and Unit Economics Controller"
ASPECT_ARTIFACT_ID = "business_finance_packet"
ASPECT_PACKET_PATH = "business_finance_packet.json"
